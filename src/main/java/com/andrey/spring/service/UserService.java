...
import com.andrey.spring.mapper.UserCreateEditMapper;
import com.andrey.spring.mapper.UserReadMapper;
...
//    @PostFilter("@companyRepository.findById(filterObject.company.id()).isPresent()")
    ...
    public boolean delete(Long id){
        return userRepository.findById(id)
                .map(entity -> {
                    ...
                    userRepository.flush();//Опрерация commit флашит, но так как ее в тестах нету,нужно флашить явно
                    return true;
                    })
                .orElse(false);
    }
